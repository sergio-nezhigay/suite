(() => {
  ...
  // extensions/stage-control-order-index/src/ActionExtension.tsx
  ...
  function getOrdersTags(orderIds) {
    return __async(this, null, function* () {
      ...
      const tagQueryResults = yield Promise.all(orderTagPromises);
      const tags = [];
      tagQueryResults.forEach(({ data }) => {
        var _a;
        if ((_a = data == null ? void 0 : data.order) == null ? void 0 : _a.tags) {
  ...
  function updateOrdersTags(_0) {
    return __async(this, arguments, function* ({
      ...
      const currentTags = yield getOrdersTags(orderIds);
      ...
      if (currentTags.length > 0) {
        ...
        try {
          const removeTagsResults = yield Promise.all(removeTagsPromises);
      ...
      try {
        const addTagsResults = yield Promise.all(addTagsPromises);
  ...
  function App() {
    ...
    (0, import_react12.useEffect)(() => {
      function fetchOrderTags() {
        return __async(this, null, function* () {
          const tags = yield getOrdersTags(selectedIds);
    ...
    const onSelect = (0, import_react12.useCallback)(
      (newValue) => __async(this, null, function* () {
        setLoading(true);
        yield updateOrdersTags({ value: newValue, orderIds: selectedIds });
        setValue(newValue);
        setLoading(false);
      }),
      [value]
      ...
      AdminAction2,
      {
        primaryAction: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Button2,
          {
            ...
            disabled: loading,
            children: "Close after selecting"
          }
        ),
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Select2,
          {
...
//# sourceMappingURL=stage-control-order-index.js.map
