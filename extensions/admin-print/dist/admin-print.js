(() => {
  ...
  function App() {
    ...
    const [src, setSrc] = (0, import_react12.useState)(null);
    const [printInvoice, setPrintInvoice] = (0, import_react12.useState)(true);
    const [printPackingSlip, setPrintPackingSlip] = (0, import_react12.useState)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AdminPrintAction2, { src, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { blockGap: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { fontWeight: "bold", children: i18n.translate("documents") }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { name: "Invoice", checked: printInvoice, onChange: (value) => {
        setPrintInvoice(value);
      }, children: "Invoice" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { name: "Packing Slips", checked: printPackingSlip, onChange: (value) => {
        setPrintPackingSlip(value);
      }, children: "Packing Slips" })
    ] }) });
  }
})();
